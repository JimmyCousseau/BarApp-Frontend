...
@Component({
  selector: 'app-modify-role-template',
  templateUrl: './modify-role-template.component.html',
  styles: [],
})
export class ModifyRoleTemplateComponent extends BaseTemplateComponent {
